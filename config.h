...
#define DC_TERRAIN_VAR_KEY_POSITION_STATE_X	DC_TERRAIN_VAR_KEY_BASE_ID + 7
#define DC_TERRAIN_VAR_KEY_POSITION_STATE_Y	DC_TERRAIN_VAR_KEY_BASE_ID + 7
#define DC_TERRAIN_VAR_KEY_POSITION_STATE_Z	DC_TERRAIN_VAR_KEY_BASE_ID + 7
